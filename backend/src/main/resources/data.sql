...
INSERT INTO `users` (`id`, `email`, `nom`, `password`, `role`, `statut`, `telephone`, `est_supprime`)
...
INSERT INTO `prestataires` (`id`, `horaires`, `localisation`, `secteur`)
VALUES (4, '09:00-18:00', 'Rabat', 'Génie Logiciel');

-- 3. Insertion du Service de consultation
INSERT INTO `services` (`id`, `nom`, `description`, `duree`, `prix`, `statut`, `prestataire_id`, `est_disponible`, `est_supprime`)
VALUES (1, 'Consultation DSE', 'Analyse', 30, 200.0, 'ACTIF', 4, b'1', b'0');

-- 4. Insertion des Créneaux disponibles
INSERT INTO `creneaux` (`id`, `date_debut`, `date_fin`, `statut`, `prestataire_id`, `service_id`) VALUES
